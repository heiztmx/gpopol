...
$permisos = $ses->validar_sesion();
  ...
  <head>
    ...
    <script src="../../herramientas/jsHerramientas/Mascaras.js"></script>
  ...
  <body>
    ...
    include '../submenus/menucartera.php';
...
<div class="modal fade bd-example-modal-lg" id="generadorExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top: 3%">
  <div class="modal-dialog modal-lg">
   ...
   <div class="modal-header" style="background-color: #007BFF; color: white">
        ...
        <button type="button" class="close" style="color: white" data-dismiss="modal" aria-label="Close" onclick=''>
