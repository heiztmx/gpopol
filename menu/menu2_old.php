...
<!-- z-index: 10000" -->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top font-weight-bold" style="font-family: 'Poppins',Helvetica,Arial,Lucida,sans-serif;margin-bottom:50px;z-index:2000;background-color:#a00;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      for ($i = 0; $i < count($permisos["modulos_autorizados"]); $i++) {
        ...
        if ($nombre  != "HERRAMIENTAS") {
         ...
         <a   id='modulo1' class='nav-link' href='../" . $link . "'>" . ucfirst(strtolower($nombre)) . "<span class='sr-only'>(current)</span></a>
         </li>";
       }else{
   ...
   <form class="form-inline my-2 my-lg-0">
    <label style="color: white;  margin-right: 25px;" for="">Bienvenido: <a style="margin-left: 10px; color: white" href="perfilUsuario.php"><?php echo $_SESSION["user"]; ?></a></label>

    <button style="margin-left: 10px;" class="btn btn-outline-secondary my-2 my-sm-0"><a href="../../../cerrarsesion.php" style="text-decoration:none; color: white">Cerrar Sesion</a></button>
  </form>
